...
class GPKAppealRegionalProcessor(BaseProcessor):
    ...
    #         v["От 2 до 6 месяцев"],
    #         v["От 6 месяцев до 1 года"],
    #         v["Свыше года"],
    #         v["Не сдано в канц. свыше срока"],
    #         v["Нарушений сдачи в канц. с нач. года"],
    #         v["Нарушение сдачи в экспедицию за неделю"],
    #         v["Нарушение сдачи в экспедицию с начала года"],
    #     ]
    #
    ...
    #         t["От 2 до 6 месяцев"],
    #         t["От 6 месяцев до 1 года"],
    #         t["Свыше года"],
    #         t["Не сдано в канц. свыше срока"],
    #         t["Нарушений сдачи в канц. с нач. года"],
    #         t["Нарушение сдачи в экспедицию за неделю"],
    #         t["Нарушение сдачи в экспедицию с начала года"],
    #     ]
