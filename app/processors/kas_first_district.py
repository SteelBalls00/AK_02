...
class KASFirstDistrictProcessor(BaseProcessor):
    ...
    COLUMN_TO_INCLUDED_CATEGORY = {
        "Приостановлено\nдел\n(из них из-за призыва)": "Приостановлено дел из-за призыва",
    ...
    def build(self, raw_data, week_index):
        ...
        return {
            ...
            "tooltips": [
                ...
                "Количество приостановленных дел\n(сколько приостановлено именно из-за призыва)",
    ...
    def _format_row(self, j, v):
        return [
            ...
            f'{v["Приостановлено дел"] + v["Приостановлено дел из-за призыва"]} ({v["Приостановлено дел из-за призыва"]})',
    ...
    def _build_total_row(self, t):
        return [
            ...
            f'{t["Приостановлено дел"] + t["Приостановлено дел из-за призыва"]} ({t["Приостановлено дел из-за призыва"]})',
